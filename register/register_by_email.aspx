<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="register_by_email.aspx.cs" Inherits="register_register_by_email" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <style>
         #ContentPlaceHolder1_email,#ContentPlaceHolder1_username,#ContentPlaceHolder1_password,#ContentPlaceHolder1_password_check,#ContentPlaceHolder1_validate_code{
    width: 350px;
    height: 42px;   
    padding: 0 15px;
    ...
    <div class="register_by_email" align="center">
	<form id="form1" runat="server" class="form-horizontal" >
		<fieldset>
			<legend>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font  size="5" face="verdana" color="white">邮箱注册</font></legend>
			<br />
            <br />
            <table ID="Table1" runat="server" height="250px" width="500px" align="center">
			<tr><td class="auto-style" >邮箱地址:</td><td>
