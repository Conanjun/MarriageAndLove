...
<div class="login-bottom" align="center">
	<form id="form1" runat="server" class="form-horizontal" >
		<fieldset>
			<legend>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font  size="5" face="verdana" color="white">邮箱登录</font></legend>
			<br />
            <br /> 
            <table ID="Table1" runat="server" height="250px" width="500px" align="center">
			<tr><td class="auto-style1" >邮箱:</td><td >
				<asp:TextBox ID="email" runat="server" align="right" OnTextChanged="email_TextChanged"></asp:TextBox>
				</td></tr>
